...
const bookId = book.id || (book as any)._id; // fallback لو البيانات فيها _id
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden transform hover:-translate-y-1 transition-transform duration-300">
      <Link href={`/book/${bookId}`} className="block cursor-pointer">
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2 mt-4">
          <Link href={`/book/${bookId}`} className="flex-1 cursor-pointer">
